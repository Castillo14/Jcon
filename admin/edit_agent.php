<?php
			...
			<?php
				...
				if(isset($_GET['edit_agent'])){
					...
					$edit_agent = "select * from tbl_agents where agent_id = '$edit_id'";

					$run_edit = mysqli_query($con,$edit_agent);
			...
			<div class="panel-body"><!-- panel-body Starts -->
				<form class="form-horizontal" action="" method="post"><!-- form-horizontal Starts -->
					...
					<div class="form-group"><!-- form-group Starts -->
						...
						<div class="col-md-6">
							<input type="email" name="email_address" class="form-control" required value="<?php echo $e_email; ?>">
						</div>
					</div><!-- form-group Ends -->
...
<?php
	...
	if(isset($_POST['update'])){
		...
		$edit_agnt = "update tbl_agents set first_name = '$first_name', middle_name = '$middle_name', last_name = '$last_name', contact_number = '$contact_number', email_address = '$email_address' where agent_id = '$edit_id'";
