			...
			<div class="panel-body"><!-- panel-body Starts -->
				<form class="form-horizontal" action="" method="post"><!-- form-horizontal Starts -->
					...
					<div class="form-group"><!-- form-group Starts -->
						...
						<div class="col-md-6">
							<input type="number" name="amount_d" class="form-control" required>
						</div>
					</div><!-- form-group Ends -->
					<div class="form-group"><!-- form-group Starts -->
						<label class="col-md-3 control-label">
					...
					<div class="form-group"><!-- form-group Starts -->
						...
						<div class="col-md-6">
							<a href="index?view_expense=<?php echo $id; ?>" class="btn btn-danger form-control">
								Cancel
							</a>
						</div>
					</div><!-- form-group Ends -->
...
<?php
	...
	if(isset($_POST['update'])){
		...
		$edit_exp = "update tbl_expences set amount = '$dif', last_amount = '$amount' , deducted_amount = '$amount2' where expences_no = '$edit_id'";
