<?php
			...
			<?php
				...
				if(isset($_GET['delete_processs'])){
					...
					$delete_id = $_GET['delete_processs'];

					$get_applicant = "select * from tbl_applicant where applicant_id = '$delete_id' and status = '2'";
			...
			<div class="panel-body"><!-- panel-body Starts -->
				<form action="" method="post" class="form-horizontal">
								...
								<div class="form-group"><!-- form-group Starts -->
									...
									<div class="col-md-6">
										<a href="index.php?employees" class="btn btn-danger form-control">
											Cancel
										</a>
									</div>
								</div><!-- form-group Ends -->
...
<?php
	...
	if(isset($_POST['remove'])){
		...
		$delete_app = "update tbl_applicant set status = '1' where applicant_id = '$delete_id'";
