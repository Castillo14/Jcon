<?php
			...
			<?php
				...
				if(isset($_GET['delete_document'])){
					...
					$get_document = "select * from tbl_documents where document_id = '$delete_id'";

					$run_get = mysqli_query($con,$get_document);

					$row_delete = mysqli_fetch_array($run_get);

					$e_id = $row_delete['document_id'];

					$e_name = $row_delete['document_name'];
...
<?php
	...
	if(isset($_POST['delete'])){
		...
		$delete_doc = "delete from tbl_documents where document_id = '$delete_id'";
