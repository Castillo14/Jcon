...
<?php
	                ...
	                $applicant_id = $_REQUEST["edit_wait_applicant"];
	    
	    			$applicant_id;       

                    $edit_applicant = "select * from tbl_applicants where applicant_id = '$applicant_id' and status = '1'";
					                	...
					                	<div class='form-group'>
					                        ...
					                        <div class='col-sm-8'>
					                        	<select class='form-control' name='job_order'>
					                            	<option name='job_order' value="<?php echo $jo; ?>" hidden>
					                            		<?php echo $jo_name; ?>
					                            	</option>
					                            	<option name='job_order' value="">
					                            			
					                            		</option>
					                            	<?php

					                            	$get_j = "select * from tbl_jo";

					                            	$run_j = mysqli_query($con,$get_j);

					                            	while($row_j = mysqli_fetch_array($run_j)){

					                            		$j = $row_j['jo_no'];
					                            		$j_name = $row_j['jo_name'];
					                            	?>
					                            	
					                            		<option name='job_order' value="<?php echo $j; ?>">
					                            			<?php echo $j_name; ?>
					                            		</option>
					                            	<?php
					                            	}
					                	...
					                	<div id='applicant_info'><!-- applicant_info Starts -->
							                ...
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type='email' class='form-control' name='email_address' value="<?php echo $e_email; ?>" >
							                        </div>  
							                    </div>
							                    <div class='form-group'>
							                        <label class='control-label col-sm-4'>
							                ...
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-4'>
							                            <input type='text' class='form-control' name='height' value="<?php echo $e_height; ?>" >
							                        </div>
							                        <div class='col-sm-4'>
							                            <input type='text' class='form-control' name='weight' value="<?php echo $e_weight; ?>" >
							                        </div>  
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                ...
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    ...
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type='text' class='form-control' name='religion' value="<?php echo $e_religion; ?>" >
							                        </div>
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                             <input type='text' class='form-control' name='passport_number' value="<?php echo $e_passnumber; ?>"  maxlength='9' minlength='9'>
							                        </div>
							                    </div>
							                    <div class='form-group'>
							                        <label class='control-label col-sm-4'>
							                        ...
							                        <div class='col-sm-8'>
							                            <textarea class='form-control' name='place_issue' rows='3' ><?php echo $e_pissue; ?></textarea>
							                        </div>
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-12'><!-- col-md-12 Starts -->
...
$applicant_id = mysqli_real_escape_string($con,$_POST['applicant_identify']);
            ...
            $j_order = mysqli_real_escape_string($con,$_POST['job_order']);
